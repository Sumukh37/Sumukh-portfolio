    ...
    className="my-20 text-center text-4xl">Experience</motion.h1>
      <div>
        {EXPERIENCES.map((experience, index) => (
            <div 
            key={index} className="mx-16 mb-8 flex flex-wrap lg:justify-center">
                <motion.div 
                ...
                className="w-full max-w-xl lg:w-3/4">
                    <h6 className="mb-2 font-semibold">{experience.role} - {" "}
                        <span style={{display: "inline-block"}}className="text-sm text-purple-100">{experience.company}</span></h6>
